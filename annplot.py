...
# mlp = MLPRegressor(hidden_layer_sizes=(8,8), activation='relu', solver='adam', max_iter=500)
...
for i in range(n):
    ...
    for i in range(len(solvers)):
        ...
        print("MODEL SCORE: ", model_score)
        activation_model_scores.append(model_score)
        # model_scores.append(model_score)

    plt.plot(solvers, activation_model_scores, label="model scores")
#plt.plot(range(n), model_scores, label="Iteration")
#plt.legend()
plt.show()